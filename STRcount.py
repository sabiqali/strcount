...
str_graph_generator = os.system(f"python ./scripts/genome_str_graph_generator.py --ref {ref} --config {config_file} {rep_orientation_arg} {pre_orientation_arg} {suf_orientation_arg} > {out_dir}tmp/genome_str_graph.gfa")
...
parse_gaf = os.system(f"python ./scripts/parse_gaf.py --input {out_dir}tmp/genome_str_graph.gfa {min_id_arg} {min_align_arg} {span_arg} > {out_dir}{out_file}")
